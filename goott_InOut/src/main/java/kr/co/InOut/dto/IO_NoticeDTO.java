...
public class IO_NoticeDTO {
	...
	public String getNotice_man_dept() {
		return notice_man_dept;
	}
	public void setNotice_man_dept(String notice_man_dept) {
		this.notice_man_dept = notice_man_dept;
	}
	public String getNotice_man_tel() {
		return notice_man_tel;
	}
	public void setNotice_man_tel(String notice_man_tel) {
		this.notice_man_tel = notice_man_tel;
	}
	public String getNotice_man_mp() {
		return notice_man_mp;
	}
	public void setNotice_man_mp(String notice_man_mp) {
		this.notice_man_mp = notice_man_mp;
	}
	public String getNotice_man_email() {
		return notice_man_email;
	}
	public void setNotice_man_email(String notice_man_email) {
		this.notice_man_email = notice_man_email;
	}
	public String getNotice_comp_type() {
		return notice_comp_type;
	}
	...
	public String getNotice_req_workday() {
		return notice_req_workday;
	}
	public void setNotice_req_workday(String notice_req_workday) {
		this.notice_req_workday = notice_req_workday;
	}
	public String getNotice_req_worktime() {
		return notice_req_worktime;
	}
	...
	public String getNotice_prcs_job() {
		return notice_prcs_job;
	}
	public void setNotice_prcs_job(String notice_prcs_job) {
		this.notice_prcs_job = notice_prcs_job;
	}
	public Date getNotice_prcs_start() {
		return notice_prcs_start;
	}
	public void setNotice_prcs_start(Date notice_prcs_start) {
		this.notice_prcs_start = notice_prcs_start;
	}
	public Date getNotice_prcs_end() {
