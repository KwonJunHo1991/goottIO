...
public class IO_Comp_RprsntDTO {
	...
	String comp_blog;
	String comp_instagram;
	String comp_facebook;
	String comp_youtube;
	String comp_twitter;
	String comp_sns_etc;
	...
	public String getComp_bgr_imgurl() {
		return comp_bgr_imgurl;
	}
	public void setComp_bgr_imgurl(String comp_bgr_imgurl) {
		this.comp_bgr_imgurl = comp_bgr_imgurl;
	}
	public String getComp_oneline_intro() {
		return comp_oneline_intro;
	}
	public void setComp_oneline_intro(String comp_oneline_intro) {
		this.comp_oneline_intro = comp_oneline_intro;
	}
	public String getComp_homepage() {
		return comp_homepage;
	}
	public void setComp_homepage(String comp_homepage) {
		this.comp_homepage = comp_homepage;
	}
	public String getComp_blog() {
		return comp_blog;
	}
	public void setComp_blog(String comp_blog) {
		this.comp_blog = comp_blog;
	}
	public String getComp_instagram() {
		return comp_instagram;
	}
	public void setComp_instagram(String comp_instagram) {
		this.comp_instagram = comp_instagram;
	}
	public String getComp_facebook() {
		return comp_facebook;
	}
	public void setComp_facebook(String comp_facebook) {
		this.comp_facebook = comp_facebook;
	}
	public String getComp_youtube() {
		return comp_youtube;
	}
	public void setComp_youtube(String comp_youtube) {
		this.comp_youtube = comp_youtube;
	}
	public String getComp_twitter() {
		return comp_twitter;
	}
	public void setComp_twitter(String comp_twitter) {
		this.comp_twitter = comp_twitter;
	}
	public String getComp_sns_etc() {
		return comp_sns_etc;
	}
	public void setComp_sns_etc(String comp_sns_etc) {
		this.comp_sns_etc = comp_sns_etc;
	}
	public String getComp_benefits() {
		return comp_benefits;
	}
	public void setComp_benefits(String comp_benefits) {
		this.comp_benefits = comp_benefits;
	}
	public String getComp_club() {
		return comp_club;
	}
	public void setComp_club(String comp_club) {
		this.comp_club = comp_club;
	}
	public String getComp_greeting() {
		return comp_greeting;
	}
	...
	public void setComp_outline(String comp_outline) {
		this.comp_outline = comp_outline;
	}
	...
	public String getComp_inro_imgul1() {
		return comp_inro_imgul1;
	}
	public void setComp_inro_imgul1(String comp_inro_imgul1) {
		this.comp_inro_imgul1 = comp_inro_imgul1;
	}
	public String getComp_inro_imgul2() {
		return comp_inro_imgul2;
	}
	public void setComp_inro_imgul2(String comp_inro_imgul2) {
		this.comp_inro_imgul2 = comp_inro_imgul2;
	}
	public String getComp_inro_imgul3() {
		return comp_inro_imgul3;
	}
	public void setComp_inro_imgul3(String comp_inro_imgul3) {
		this.comp_inro_imgul3 = comp_inro_imgul3;
	}
	public String getComp_inro_imgul4() {
