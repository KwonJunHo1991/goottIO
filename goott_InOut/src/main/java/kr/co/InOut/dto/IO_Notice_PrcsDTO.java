...
public class IO_Notice_PrcsDTO {
	...
	public IO_Notice_PrcsDTO(int notice_prcs_num, int notice_num, int comp_num,
			int notice_prcs_type, String comp_id, String notice_prcs_name,
			Date notice_prcs_detail_start, Date notice_prcs_detail_end) {
		super();
	...
	public int getNotice_prcs_num() {
		return notice_prcs_num;
	}
	public void setNotice_prcs_num(int notice_prcs_num) {
		this.notice_prcs_num = notice_prcs_num;
	}
	...
	public int getNotice_prcs_type() {
		return notice_prcs_type;
	}
	public void setNotice_prcs_type(int notice_prcs_type) {
		this.notice_prcs_type = notice_prcs_type;
	}
