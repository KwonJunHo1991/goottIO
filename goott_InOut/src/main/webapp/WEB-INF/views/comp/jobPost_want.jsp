...
<script type="text/javascript">
	$(function(){
		...
		/* 체크박스 두번 누르면 선택 해제 */
/* 		$('.three_depth_preferential').is(':checked')(function(){
...
<!-- 두번째 section -->
		...
		<input type="hidden" name="comp_num" value='${sessionScope.loginComp.comp_num }' />
			...
			<button type="submit" id="btn_next" class="btn btn-primary btn-lg" style="border: none; background-color: white; margin: 0 auto; width:100%; "> 다음 페이지 </button>
