...
$(document).ready(function () {
	...
	var url = ("../InOut/test7.do?name="+company_chose_name+"&content="+company_chose_context);
	 	
		window.open(url,"confirm","toolbar = no, location = no, status = np, menubar = no, width = 550, height=500, left=700, top=250, menubar =no, overflow-x:hidden,overflow-y:hidden ");
	});
				...
				<div class="wrap_jv_cont">
					...
					<div class="wrap_jv_header">
						<div class="jv_header">
							...
							onmousedown="try{n_trackEvent('relay_view', 'title', 'company', '');}catch(e){}" id="company_name">@ 회사 이름 @</a>
					...
					<div class="jv_cont jv_detail">
						...
						<div class="jv_cont jv_company">
							...
							<div class="cont_box">
								<div class="logo">
									<img src="<c:url value="/resources/images/logo.jpg"/>" alt="회사 로고"
